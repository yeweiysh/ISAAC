...
filename=['C:\Users\ye\Desktop\workspace\isa for synthdata\ITE-0.52_code\code\Synthetic data\10dim\' num2str(num) '\10views.mat'];
save(filename,'x','-mat');

%2 4 30 50 80 100 120 200 300 400